...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const updateData = {
      ...
      organizer_name: organizer_name?.trim() || 'Neimed 팀',
      organizer_email: organizer_email?.trim() || 'support@neimed.com',
      organizer_phone: organizer_phone?.trim() || '02-1234-5678',
      organizer_kakao: organizer_kakao?.trim() || '@neimed_official',
